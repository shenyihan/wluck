...
public class ContextConfig {
    private String templatePrefixPath = "wluckTemplate";
    private String projectPath = "F:\\work";//模板输出的项目目录
    ...
    private String proPackage = "com.muyicheng.wluck.mgr";
    private String coreBasePackage = "com.muyicheng.wluck.core";
    private String modelPackageName = "com.muyicheng.wluck.mgr.system.entity";        //model的包名
    private String modelMapperPackageName = "com.muyicheng.wluck.mgr.system.mapper";    //model的dao
