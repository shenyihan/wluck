...
import com.muyicheng.wluck.mgr.common.constant.MenuDict;
import com.muyicheng.wluck.mgr.common.constant.factory.ConstantFactory;
import com.muyicheng.wluck.mgr.common.constant.state.MenuStatus;
import com.muyicheng.wluck.mgr.common.exception.BizExceptionEnum;
import com.muyicheng.wluck.mgr.common.node.ZTreeNode;
import com.muyicheng.wluck.mgr.system.entity.Menu;
import com.muyicheng.wluck.mgr.system.service.IMenuService;
import com.muyicheng.wluck.mgr.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new WLuckException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new WLuckException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
