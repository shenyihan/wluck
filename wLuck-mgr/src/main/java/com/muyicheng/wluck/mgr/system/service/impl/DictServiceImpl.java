...
import com.muyicheng.wluck.mgr.system.mapper.DictMapper;
import com.muyicheng.wluck.mgr.system.service.IDictService;
...
import static com.muyicheng.wluck.mgr.common.constant.factory.MutiStrFactory.MUTI_STR_KEY;
import static com.muyicheng.wluck.mgr.common.constant.factory.MutiStrFactory.MUTI_STR_VALUE;
import static com.muyicheng.wluck.mgr.common.constant.factory.MutiStrFactory.parseKeyValue;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new WLuckException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new WLuckException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
